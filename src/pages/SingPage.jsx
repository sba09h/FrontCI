  ...
  useEffect(() => {
    const fetchDocument = async () => {
      const response = await axios.get(
        `http://localhost:3000/api/contratos/${id}`
      );
    ...
    <>
      ...
      <div className="p-10">
        <div className="flex flex-col justify-center  font-bold text-3xl bg-r">
          <a className="justify-center text-center" href="">
            CONSENTIMIENTO INFORMADO Y/O TÉRMINOS Y CONDICIONES
          </a>{" "}
          <br />
          <p className="font-bold"> {document.titulo} </p>
          <br />
          <p className="font-light text-justify mx-20">
            Descripción: {document.contenido}{" "}
          </p>
          <br />
        ...
        <form onSubmit={firmarDocumento} className="flex flex-col ">
          ...
          <div className="flex items-center space-x-2 mt-2">
            ...
            <button
              ...
              className="bg-rose-500 text-white px-4 py-2 rounded-md hover:bg-red-900"
            >
