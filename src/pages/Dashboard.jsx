  ...
  return (
    <>
      ...
      <div className="flex pt-20 justify-center">
        <div className="flex flex-col w-2/4 bg-zinc-700 rounded-md" style={{ padding: "20px", fontFamily: "Arial, sans-serif" }}>
          <h1 className="font-semibold text-3xl py-5 ">Firma de Documentos</h1>
          <div>
            <p className="pt-3"><strong>Nombre:</strong> {user.nombre || "No disponible"}</p>
          </div>
          <ContractsList/> 
          <HistorialContratos/>
        </div>
